...
class Elevator(pygame.sprite.Sprite):
    ...
    def UpdatePosition(self):
       ...
       if self._positionY == self.startPosY:
            self.Dir = ElevatorDir.DOWN
       elif  self._positionY == self.startPosY + 300:
...
class Game(object):
      ...
      def run(self,done):
            ...
            for i in elevator:
                 ...
                 if self.playerCharacter.feet[1] >= i.rect[1] - 8 and self.playerCharacter.feet[1] <= i.rect[1] + 8 and self.playerCharacter.feet[0] >= i.rect[0] - 10 and self.playerCharacter.feet[0] <= i.rect[0] + 80:
